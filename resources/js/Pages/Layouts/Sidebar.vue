    ...
    <aside ref="sidebarMmultiLevelSidebar" id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform sm:translate-x-0" >
        <div class="h-full px-3 py-4 overflow-y-auto bg-slate-900 dark:bg-gray-800">
            ...
            <ul class="space-y-2 font-medium ">
                <li>
                    <Link href="/dashboard" class="flex items-center p-2 text-white rounded-lg ">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-white">
                ...
                <li>
                    <Link :href="route('jadwal.jadwalSaya')" class="flex items-center p-2  rounded-lg text-white ">
                ...
                <li v-if="$page.props.auth.admin == true">
                    <Link :href="route('dataVaksin')" class="flex items-center p-2 text-white rounded-lg ">
                ...
                <li  v-if="$page.props.auth.admin == true">
                    <Link :href="route('jadwal.index')" class="flex items-center p-2 text-white rounded-lg ">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-white">
                ...
                <li  v-if="$page.props.auth.admin == true">
                    <Link :href="route('index.laporan')" class="flex items-center p-2 text-white rounded-lg ">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <li>
                    <a @click="logout" href="#" class="flex items-center p-2 text-white rounded-lg ">
